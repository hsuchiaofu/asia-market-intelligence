...
from site_tools import ROOT,add_report,extract_meta_description,validate_source,VALID_TYPES
def main():
    ...
    for kind in kinds:
        ...
        for source in sorted(folder.glob('*.html')):
            ...
            try:
                ...
                summary=extract_meta_description(validate_source(source))
                add_report(kind,day,VALID_TYPES[kind],summary,source)
